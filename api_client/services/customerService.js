...
app.service('customersService', function () {
    ...
    var customers = [
        {
            id: 1, firstName: 'LeeLee', lastName: 'Carroll', address: '1234 Anywhere St.', city: 'Phoenix',
            orders: [
        ...
        {
            id: 2, firstName: 'JesseJames', lastName: 'Hawkins', address: '89 W. Center St.', city: 'Atlanta',
            orders: [
